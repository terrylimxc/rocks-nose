...
def main():
    ...
    parser.add_argument("-l", "--label", default="NA", help="File containing labels for training data")
    parser.add_argument("-d", "--data", default='NA', help="Training data")
    parser.add_argument("-m", "--model", default='SmoteTomek', help="Choice of model to used for training (SmoteTomek or BalancedRF)")
    parser.add_argument("-o", "--output", default='model', help="Output name to save trained model")
...
def encoder(data, method='train'):
    """
    In the handout, it was explained that the nucleotide column of the dataset represents the combined nucleotides from the neighboring 1-flanking position.
    Since this column is in the form of string data, encoding should be carried out to convert these strings into categorical data.
